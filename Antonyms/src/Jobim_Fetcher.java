...
public class Jobim_Fetcher {
	...
	public ArrayList<String> process_word(String w) throws Exception {
		...
		for (int i=0; i<ja.length(); i++) {
			...
			System.out.println(trim_word);
		}
		return word_string;        
	}
	// Jobim uses standard formats like "hugh#JJ" to specify it as an adjective or "#NN" as noun
	...
	public static void main(String[] args) throws Exception {
		...
		String w = "huge";
		//jf.process_sentence(s);
		//String w2 = jf.identify_word_type(w);
